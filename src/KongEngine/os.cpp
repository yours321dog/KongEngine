...
#if defined(_KONG_COMPILE_WITH_SDL_DEVICE_)
#include <SDL/SDL_endian.h>
#define bswap_16(X) SDL_Swap16(X)
#define bswap_32(X) SDL_Swap32(X)
#elif defined(_KONG_WINDOWS_API_) && defined(_MSC_VER) && (_MSC_VER > 1298)
#include <stdlib.h>
...
#elif !defined(_KONG_SOLARIS_PLATFORM_) && !defined(__PPC__) && !defined(_KONG_WINDOWS_API_)
#include <byteswap.h>
#else
...
namespace kong
{
    namespace os
    {
        ...
        f32 Byteswap::byteswap(f32 num) { u32 tmp = core::IR(num); tmp = bswap_32(tmp); return (core::FR(tmp)); }
...
#if defined(_KONG_WINDOWS_API_)
// ----------------------------------------------------------------
// Windows specific functions
// ----------------------------------------------------------------

#ifdef _KONG_XBOX_PLATFORM_
#include <xtl.h>
#else
...
namespace kong
{
    namespace os
    {
        ...
        {
#if !defined(_WIN32_WCE) && !defined (_KONG_XBOX_PLATFORM_)
