...
#ifdef _KONG_COMPILE_WITH_LIBPNG_
#ifndef _KONG_USE_NON_SYSTEM_LIB_PNG_
#include <png.h> // use system lib png
#else // _KONG_USE_NON_SYSTEM_LIB_PNG_
#include "libpng/png.h" // use irrlicht included lib png
#endif // _KONG_USE_NON_SYSTEM_LIB_PNG_
#endif // _KONG_COMPILE_WITH_LIBPNG_
...
namespace kong
{
    namespace video
    {
        ...
        bool CImageLoaderPng::IsALoadableFileExtension(const io::SPath& filename) const
        {
#ifdef _KONG_COMPILE_WITH_LIBPNG_
