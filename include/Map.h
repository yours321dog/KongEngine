// Copyright (C) 2006-2012 by Kat'Oun 2018 by Luan Lyu
...
namespace kong
{
    namespace core
    {
        ...
        class Map
        {
            //! red/black tree for map_KONG_IMPLEMENT_MANAGED_MARSHALLING_BUGFIX
        ...
        public:
            ...
            public:
                ...
                Node& operator*()
                {
                    _KONG_DEBUG_BREAK_IF(atEnd()) // access violation
            ...
            public:
                ...
                operator ValueType()
                {
                    ...
                    // Not found
                    _KONG_DEBUG_BREAK_IF(node == 0) // access violation
            ...
            _KONG_DEPRECATED_ bool isEmpty() const
            {
                return empty();
            }
