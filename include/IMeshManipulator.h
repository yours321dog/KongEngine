    ...
    namespace scene
    {
        ...
        */
        ...
        public:
            ...
            virtual void flipSurfaces(kong::scene::IMesh* mesh) const = 0;

            //! Sets the alpha vertex color value of the whole mesh to a new value.
            /** \param mesh Mesh on which the operation is performed.
            \param alpha New alpha value. Must be a value between 0 and 255. */
            void setVertexColorAlpha(kong::scene::IMesh* mesh, kong::s32 alpha) const
            {
            ...
            */
            ...
            \param mesh Mesh on which the operation is performed.
            \param factor Scale factor for each axis. */
            _KONG_DEPRECATED_ void scaleMesh(IMesh* mesh, const core::vector3df& factor) const { return scale(mesh, factor); }
            ...
            void transform(IMesh* mesh, const core::Matrixf& m) const
            {
            ...
            /** \param buffer Meshbuffer on which the operation is performed.
            \param m transformation matrix. */
            void transform(IMeshBuffer* buffer, const core::Matrixf& m) const
            {
            ...
            \param mesh Mesh on which the operation is performed.
            \param m transformation matrix. */
            _KONG_DEPRECATED_ virtual void transformMesh(IMesh* mesh, const core::Matrixf& m) const { return transform(mesh, m); }
